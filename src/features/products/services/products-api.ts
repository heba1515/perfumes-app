...
const MOCK_PRODUCTS: readonly Product[] = [
  {
    ...
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGmWfCMK3p38UrzNvKVUdY1tvZEXHOc8tyDYw_Bwnc0w&s=10',
    rating: 4.8,
    reviewCount: 142,
    inStock: true,
    scentFamily: 'Floral',
  ...
  },
  {
    ...
    price: 220,
    category: 'footwear',
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRnMcw1PhoS6OLteMVWpwy6-gl5VetXqvsya0q_spObQ&s=10',
    rating: 4.7,
    reviewCount: 98,
    inStock: true,
    scentFamily: 'Woody',
  ...
  },
  {
    ...
    imageUrl: 'https://www.maxfieldla.com/cdn/shop/files/386492-62535-Trudon-Mortel-Noir-Eau-De-Parfum-2_2db9c7c8b80a4276933130817893cc77.jpg?v=1783988131&width=1200',
    rating: 4.9,
    reviewCount: 64,
    inStock: true,
  ...
  },
  {
    ...
    price: 185,
    category: 'apparel',
    imageUrl: 'https://www.oriental-fragrance.com/4106/oud-elite-soleil-d-or.jpg',
    rating: 4.6,
    reviewCount: 53,
    inStock: false,
    scentFamily: 'Fresh',
  ...
  },
  {
    ...
    price: 310,
    category: 'electronics',
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLKjQ7QzbcmKi9TGv_7cULaO3nM6LgDzOXtnzUXCTLoZQDdA9SW68Zz7eT&s=10',
    rating: 4.9,
    reviewCount: 210,
    inStock: true,
    scentFamily: 'Woody',
  ...
  },
  {
    ...
    price: 205,
    category: 'accessories',
    imageUrl: 'https://lh7-us.googleusercontent.com/zBJZoAVduVX07rtcoC1eVnoYEbDpmgUUXUXEca2pq7xyArzqit60CKpVCEgWTIaqi-ziw0iMAsjb5QviOqn4l8bz-jE5BUd4HYqw2S62ZGqogYMY_kLJ8Z-msrv0wyJAAiSKZfxOpitj6M0uCJOanAw',
    rating: 4.5,
    reviewCount: 39,
    inStock: true,
    scentFamily: 'Floral',
